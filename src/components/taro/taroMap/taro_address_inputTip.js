...
import { View, Text,Button,Map,Image,CoverView,Input } from '@tarojs/components';
      ...
      <View className='wrap taro_map'>
        ...
        <View style={{position:"absolute",left:"10px",top:"10%"}}>
          <Input type='text' 
            ...
            placeholder='输入地址'
            onInput={this.handelChange_input.bind(this,"inputValue")} 
          />
        </View>
      </View>
    )
